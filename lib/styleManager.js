...
/**
 * Single ShaderEffect handling brightness and saturation in one fragment-shader pass.
 * ShaderEffect (unlike BrightnessContrastEffect / DesaturateEffect, both OffscreenEffect
 * subclasses) does not allocate a per-actor framebuffer, so dimming many windows costs
 * essentially no GPU memory. See docs/dim-effect.md for the curve-change rationale.
 */
